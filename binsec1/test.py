...
l = run_command('..\\..\\build\\SATURN-clang-8.0 file_1.c -O0 -S -emit-llvm')[1]
l = run_command('..\\..\\build\\SATURN-clang-8.0 file_1.c -O0 -o test.exe')[1]
#print l
