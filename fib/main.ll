...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local dllexport i32 @fib(i32 %n) #0 {
entry:
  ...
  store i32 1, i32* %prev2, align 4
  store i32 1, i32* %prev1, align 4
  br label %while.cond
...
while.body:                                       ; preds = %while.cond
  %1 = load i32, i32* %prev1, align 4
  %2 = load i32, i32* %prev2, align 4
  %add = add nsw i32 %1, %2
  store i32 %add, i32* %current, align 4
  %3 = load i32, i32* %prev1, align 4
  store i32 %3, i32* %prev2, align 4
  %4 = load i32, i32* %current, align 4
  store i32 %4, i32* %prev1, align 4
  br label %while.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @fib_test(i32 %n) #0 {
entry:
  %n.addr = alloca i32, align 4
  %prev1 = alloca i32, align 4
  %prev2 = alloca i32, align 4
...
entry:
  ...
  %call2 = call i32 @fib_test(i32 %2)
  %3 = load i32, i32* %i, align 4
  %call3 = call i32 @fib(i32 %3)
