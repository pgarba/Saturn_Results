...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local dllexport i32 @edges(i32 %n) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @edges_test(i32 %n) #0 {
entry:
  %retval = alloca i32, align 4
  %n.addr = alloca i32, align 4
  %a = alloca i32, align 4
...
entry:
  ...
  %call2 = call i32 @edges_test(i32 %2)
  %3 = load i32, i32* %i, align 4
  %call3 = call i32 @edges(i32 %3)
  ...
  %call5 = call i32 @edges(i32 %4)
  %5 = load i32, i32* %i, align 4
  %call6 = call i32 @edges_test(i32 %5)
