...
$"??_C@_0BG@DPFKBJFJ@?$FL?$CB?$FN?5Loop?5op?5test?5?4?4?4?6?$AA@" = comdat any
...
@"??_C@_0BG@DPFKBJFJ@?$FL?$CB?$FN?5Loop?5op?5test?5?4?4?4?6?$AA@" = linkonce_odr dso_local unnamed_addr constant [22 x i8] c"[!] Loop op test ...\0A\00", comdat, align 1
...
entry:
  ...
  call void asm sideeffect inteldialect "mov rax, $0\0A\09mov rcx, $$0\0A\09mov rdx, $$0\0A\09.L__MSASMLABEL_.${:uid}__l:\0A\09inc rax\0A\09inc rcx\0A\09cmp rcx, $$10\0A\09jl .L__MSASMLABEL_.${:uid}__l\0A\09cmp rdx, $$0\0A\09je .L__MSASMLABEL_.${:uid}__l\0A\09ret", "*m,~{flags},~{rax},~{rcx},~{rdx},~{dirflag},~{fpsr},~{flags}"(i32* %n.addr) #2, !srcloc !3
...
entry:
  ...
  %n.addr = alloca i32, align 4
  store i32 %n, i32* %n.addr, align 4
  call void asm sideeffect inteldialect "mov rax, $0\0A\09mov rcx, $$0\0A\09mov rdx, $$0\0A\09.L__MSASMLABEL_.${:uid}__l:\0A\09inc rax\0A\09inc rcx\0A\09cmp rcx, $$10\0A\09jl .L__MSASMLABEL_.${:uid}__l\0A\09cmp rdx, $$0\0A\09je .L__MSASMLABEL_.${:uid}__l\0A\09ret", "*m,~{flags},~{rax},~{rcx},~{rdx},~{dirflag},~{fpsr},~{flags}"(i32* %n.addr) #2, !srcloc !4
  %0 = load i32, i32* %retval, align 4
  ret i32 %0
}
...
entry:
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @"??_C@_0BG@DPFKBJFJ@?$FL?$CB?$FN?5Loop?5op?5test?5?4?4?4?6?$AA@", i32 0, i32 0))
